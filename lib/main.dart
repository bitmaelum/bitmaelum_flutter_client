...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'BitMaelum'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  String _accountName = "<unloaded>";
  String _accountAddress = "<unloaded>";
  String _privKey = "<unloaded>";
  File _fileVault;
  String _password;
  ...
  void _openVault(String filePath, String password) async {
    try {
      ...
      for (var i = 0; i < _accounts.length; i++) {
        myAccounts.add(_accounts[i]["address"]);
      }*/

      /*setState(() {
        _accounts = result as List;
        shouldChooseAccount = true;
      });*/
